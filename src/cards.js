...
export function cardsRoll() {
    ...
    if (window.gameState.hardness === 1) {
        ...
        randomControl = []
        randomizer = 0
        mainBar.classList.remove('mainBar3')
        ...
        setTimeout(() => {
            const showUpInterval = setInterval(() => {
                ...
                mainBar.childNodes[
                    expander
                ].firstChild.firstChild.style.animation =
                    'flip-vertical-left 2s both'
                mainBar.childNodes[
                    expander
                ].firstChild.lastChild.style.animation =
                    'flip-vertical-left-back 2s both'
                if (expander === 11) {
        ...
        setTimeout(() => {
            ...
            clickAnimation.forEach((element) => {
                element.addEventListener('click', () => {
                    element.firstChild.style.animation =
                        'flip-vertical-left 2s both'
                    element.lastChild.style.animation =
                        'flip-vertical-left-back 2s both'
                    clicker += 1
                    winClicker += 1
                    ...
                    if (winClicker === 12) {
                        ...
                        let randomAnimation1 =
                            'rotate-scale-up-diag-1 2.9s both'
                        ...
                        comrade.style.animation =
                            randomAnimation[Math.round(Math.random() * 4)]
                        comrade.textContent =
                            randomText[Math.round(Math.random() * 10)]
    ...
    if (window.gameState.hardness === 3) {
        ...
        randomControl = []
        randomizer = 0
        mainBar.classList.remove('mainBar1')
        mainBar.classList.add('mainBar3')
        mainBar.style.width = '100%'
        mainBar.style.marginLeft = '0.001%'
        mainBar.style.marginRight = '0.001%'
